...
class PublicL1 extends StatefulWidget {
  const PublicL1({Key? key}) : super(key: key);
  @override
  _PublicL1State createState() => _PublicL1State();
}
class _PublicL1State extends State<PublicL1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Formulaire dinscrire public l1',
  ...
  void createDatabase() async
  {
   database = await openDatabase(
    ...
    print('database created');
     database.execute('CREATE TABLE niveaul1( id INTEGER PRIMARY KEY,name TEXT, nni INTEGER, lieu TEXT,tel INTEGER,datenaissance TEXT,email TEXT,nbac TEXT,moyenne TEXT,dateregister TEXT,)').then((value){
       print('table created ');
     }).catchError((error){
       print('error when create the table ${error.toString()}');
     });
    },
    onOpen:(database)
  {
  ...
  void insertToDatabase()
  {
     database.transaction((txn)async {
      await txn.rawInsert('INSERT INTO niveaul1(name,nni,lieu,tel,datenaissance,email,nbac,moyenne,dateregister) VALUES ("sidi",123453,"nkt","46981937","1998-10-02","sidi@gmail.com","27607","11","2022-06-05")').then((value){
