...
class publicl3 extends StatefulWidget {
  const publicl3({Key? key}) : super(key: key);

  @override
  _publicl3State createState() => _publicl3State();
}

class _publicl3State extends State<publicl3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Formulaire dinscrire public l3',
