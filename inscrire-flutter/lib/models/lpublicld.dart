...
class Lpublicld{
  ...
  Lpublicld({required this.id, required this.nom, required this.photoEtudiant,
  ...
  factory Lpublicld.fromJson(Map<String,dynamic>json){
    return Lpublicld(id: json['id'], nom: json['nom'], photoEtudiant: json['photoEtudiant'],
