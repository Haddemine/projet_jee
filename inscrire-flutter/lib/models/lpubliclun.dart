...
class Lpubliclun{
  ...
  Lpubliclun({required this.id, required this.nom, required this.photoEtudiant,
  ...
  factory Lpubliclun.fromJson(Map<String,dynamic>json){
    return Lpubliclun(id: json['id'], nom: json['nom'], photoEtudiant: json['photoEtudiant'],
