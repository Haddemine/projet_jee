...
class PublicL2 extends StatefulWidget {
  const PublicL2({Key? key}) : super(key: key);

  @override
  _PublicL2State createState() => _PublicL2State();
}

class _PublicL2State extends State<PublicL2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Formulaire dinscrire public l2',
