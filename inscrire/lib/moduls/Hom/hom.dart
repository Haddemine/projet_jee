                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: MaterialButton(
                                            onPressed: (){
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => publicl3()
                                              ),
                                              );
                                            },
                                            child: Text(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: MaterialButton(
                                              onPressed:(){
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => privel3()
                                                ),
                                                );
                                              },
                                              child: Text(
