...
class PriveL2 extends StatefulWidget {
  const PriveL2({Key? key}) : super(key: key);

  @override
  _PriveL2State createState() => _PriveL2State();
}

class _PriveL2State extends State<PriveL2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Formulaire dinscrire prive l2',
